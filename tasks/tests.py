...
class TestDocking(Task):
    ...
    def run(self):
        ...
        mol = target.dock('InChI=1S/C13H18O2/c1-9(2)8-11-4-6-12(7-5-11)10(3)13(14)15/h4-7,9-10H,8H2,1-3H3,(H,14,15)', seed=28,logfile='hello',verbose=True)
...
class TestAllPDBQTs(Task):
    ...
    def run(self):
        ...
        columns = ['smiles'] + receptors
        scores = pd.DataFrame(index=smiles,columns=columns)
        ...
        # Save dataframe
        scores.to_csv(self.output_filepath,sep='\t',index=False)
    def load_output(self):
